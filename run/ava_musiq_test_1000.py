...
# Scorer Import aus deiner neuen Klasse
...
def main():
    ...
    # Wir nutzen "cuda", da wir CUDA_VISIBLE_DEVICES im Terminal setzen
    scorer = MUSIQScorer(model_type="musiq-ava", device="cuda")

    # Wir laden nur die ersten 1000 Bilder für den Test
    ...
    # Speichern der Test-Ergebnisse
    pd.DataFrame(results).to_csv(out_path, index=False)
    print(f"\n✅ Test abgeschlossen! Datei erstellt unter: {out_path}")

    # Einmalige Speicher-Info am Ende des Tests
    scorer.print_memory()
